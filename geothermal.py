...
def getem_routine(geothermal_class, cur_dict):    
    # Defaults
    plant_type = "binary"
    if geothermal_class in [1,2]:
        plant_type = "flash"
    t_amb = cur_dict["ambient_temp"]*1.8+32 # fahrenheit
    p_amb = 14.7 # psia
    turbine_eff = 0.8 # D32
    ...
    hSink = steam_properties[1][0]*t_amb**6 + steam_properties[1][1]*t_amb**5 + steam_properties[1][2]*t_amb**4\
                + steam_properties[1][3]*t_amb**3 + steam_properties[1][4]*t_amb**2 + steam_properties[1][5]*t_amb + steam_properties[1][6]# btu/lb
    sSink = steam_properties[2][0]*t_amb**6 + steam_properties[2][1]*t_amb**5 + steam_properties[2][2]*t_amb**4\
                + steam_properties[2][3]*t_amb**3 + steam_properties[2][4]*t_amb**2 + steam_properties[2][5]*t_amb + steam_properties[2][6] # btu/lb-R

    availableEnergy = ((hSource-hSink)-(t_amb+460)*(sSource-sSink))/3.413 # w-hr/lb  | *3.413 -> btu/lb
    ...
    if plant_type == "binary":
        ...
        production_flow_rate = 873030. # lb/hr  
    else:
        pumpLift = 0
        production_flow_rate = 634931. # lb/hr  

    production_pump_eff = cur_dict['overall_pump_efficiency']/100.  # G372
    ...
    total_power = int(cur_dict['number_of_wells'])*((brine_effectiveness*production_flow_rate/1000)-
                   (total_pump_power*production_flow_rate/1000)) # kW
